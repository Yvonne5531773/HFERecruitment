...
function scoreChange(a){
    function e(){
        ...
        new Chart(b).Doughnut(c,d),
            b.canvas.width = 120, b.canvas.height = 120;
...
function click_scroll(a){
    ...
    switch(a){
        ...
        case "remark":
            $("#remark .remarkAdd").trigger("click");break;
        default:
            return
    }
...
!function(a,b) {
    ...
    $(function() {
        ...
        remark = {
            obj: $("#remark"),
            text: $("#remark .remark").val(),
            Add: function () {
                this.obj.children(".remarkEdit").find(".remark").val("");
                this.obj.children(".remarkAdd").addClass("dn");
                this.obj.children(".remarkShow").addClass("dn");
                this.obj.children(".remarkEdit").removeClass("dn")
                j(this.obj)
            },
            Edit: function () {
                var b = this.obj.children(".remarkShow").html();
                b = $.trim(b.replace(/<br>/gi, ""));
                this.text = b;
                this.obj.children(".remarkEdit").find(".remark").val(b);
                this.obj.children(".remarkEdit").find(".word_count").children("span").text(500 - b.length);
                this.obj.children(".remarkShow").addClass("dn");
                this.obj.children(".remarkEdit").removeClass("dn");
                this.obj.children(".c_edit").addClass("dn");
                j(this.obj)
            ...
            Cancel: function () {
                this.text ? (this.obj.children(".remarkAdd").addClass("dn"), this.obj.children(".remarkShow").removeClass("dn"),
                    this.obj.children(".remarkEdit").addClass("dn"),
                    this.obj.children(".c_edit").removeClass("dn")) : (this.obj.children(".remarkAdd").removeClass("dn"),
                    this.obj.children(".remarkShow").addClass("dn"), this.obj.children(".remarkEdit").addClass("dn")), k(this.obj)
            }
        }, remark.obj.children(".remarkAdd").bind("click", function () {
            remark.Add()
        }), remark.obj.children(".c_edit").bind("click", function () {
            remark.Edit()
        }), remark.obj.children(".remarkEdit").find(".btn_profile_cancel").bind("click", function () {
            remark.Cancel()
        }), remark.obj.on("keyup", ".s_textarea", function () {
            textCounter("remark", "", 500)
        });
        $(".remarkForm").validate({
            rules: {
                strength: {required: !1}
            ...
            submitHandler: function (a) {
                var remarkText = $('textarea[name="remark"]', a).val(),
                    c = $("#_id").val();
                $(a).find(":submit").val("保存中...").attr("disabled", !0);
                $.ajax({
                    url: "/resume/upsertResume",
                    ...
                    if(!res.error) {
                        if(res.remark){
                            ...
                            remark.text = "";
                            remark.obj.children(".c_edit").addClass("dn");
                            remark.obj.children(".remarkShow").addClass("dn");
                            remark.obj.children(".remarkEdit").addClass("dn");
                            remark.obj.children(".remarkAdd").removeClass("dn");
                        }
                        $("#lastChangedTime span").text(res.updated);
                        $("#resumeScore .which span").attr("rel", res.next);
                        scoreChange(res.completeScore);
